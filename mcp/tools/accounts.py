...
from tools.database import read_account, write_account, write_log
from tools.market import get_share_price
...
if __name__ == "__main__":
    ...
    account.buy_shares("AAPL", 5,"Testing")
    account.sell_shares("AAPL", 2,"Sell share test")
