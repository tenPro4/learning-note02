...
from tools.market import is_paid_polygon, is_realtime_polygon
...
if is_paid_polygon or is_realtime_polygon:
    ...
    market_mcp = {
        "command": "uv", 
        "args": ["run", "python", "-m", "tools.market_server.py"]}


# The full set of MCP servers for the trader: Accounts, Push Notification and the Market

trader_mcp_server_params = [
    {"command": "uv", "args": ["run", "python","-m", "tools.accounts_server.py"]},
    {"command": "uv", "args": ["run", "python","-m", "tools.push_server.py"]},
    market_mcp,
]
